...
Q = np.array([[-0.5625, 0.1875, 0.1875, 0.1875],
              [0.1875, -0.5625, 0.1875, 0.1875],
              [0.1875, 0.1875, -0.5625, 0.1875],
              [0.1875, 0.1875, 0.1875, -0.5625]])
...
class Tree:
    ...
    def print_tree(self, node=None, level=0):
        ...
        print(
            ' ' * level * 4 + f'Node: {node.name}, Branch Length: {node.branch_length}, Sequence: {node.sequence}, Is Final: {node.is_final}')
